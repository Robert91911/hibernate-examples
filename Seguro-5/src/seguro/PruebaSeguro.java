...
public class PruebaSeguro {
	...
	public static void main(String[] args) {
		...
		Date fecha = new Date();
		Date fechaNac = new Date(1999, 6, 23);
		Seguro seguroInsertar = new Seguro("51236964S", "Juan", "Melenez", "Jopse", 55, 2, null, null, fecha, null, fechaNac, fecha, null, null);
		...
		Seguro seguroModificar = new Seguro("51236964S", "Juan", "Melenez", "Jopse", 55, 2, 'Y', 3, fecha, "Casa", fecha, fecha, null, null);
