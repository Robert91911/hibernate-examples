package transparencias.tipos.jpa;
...
public class TiposBasicos implements Serializable {
    ...
    @Lob //Al marcarlo como @Lob, Hibernate ya se encarga de hacer una conversión adecuada
    private String texto;
    @Type(type="binary") //Se puede omitir o poner @Lob e Hibernate ya se encarga de hacer una conversión adecuada
	...
	public String toString() {
		return "TiposBasicos [inte=" + inte + ", long1=" + long1 + ", short1="
				+ short1 + ", float1=" + float1 + ", double1=" + double1
				+ ", character1=" + character1 + ", byte1=" + byte1
				+ ", boolean1=" + boolean1 + ", yesno1=" + yesno1
				+ ", truefalse1=" + truefalse1 + ", stri=" + stri
				+ ", dateDate=" + dateDate + ", dateTime=" + dateTime
				+ ", dateTimestamp=" + dateTimestamp + ", texto=" + texto
				+ ", binario=" + Arrays.toString(binario) + ", bigDecimal="
				+ bigDecimal + ", bigInteger=" + bigInteger + "]";
	}
