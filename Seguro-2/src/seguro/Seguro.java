package seguro;
// Generated 07-dic-2019 23:14:33 by Hibernate Tools 5.2.12.Final
...
@Table(name="seguro"
    ,catalog="seguros"
    , uniqueConstraints = @UniqueConstraint(columnNames="nif") 
)
public class Seguro  implements java.io.Serializable {
    ...
    public Seguro(String nif, String nombre, String ape1, String ape2, Integer edad, Integer sexo, Character casado, Integer numHijos, Date fechaCreacion, String tipoSeguro) {
       this.nif = nif;
       this.nombre = nombre;
       this.ape1 = ape1;
       this.ape2 = ape2;
